...
ZAGA_mu_treatment <- summary(ZAGA_model)[2, ]
...
vcov(GA_model, type = "se" ,  hessian.fun = "R")
vcov(GA_model, type = "se" ,  hessian.fun = "PB")
rvcov(GA_model, type = "se" )
rvcov(GA_model, type = "se", hessian.fun = "R")
...
gamlss:::vcov.gamlss(GA_model, type = "se", hessian.fun = "R", robust = TRUE)
